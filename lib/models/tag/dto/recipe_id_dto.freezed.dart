...
mixin _$RecipeIdDTO {
  ...
  @JsonKey(ignore: true)
  $RecipeIdDTOCopyWith<RecipeIdDTO> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RecipeIdDTOCopyWith<$Res> {
  factory $RecipeIdDTOCopyWith(RecipeIdDTO value, $Res Function(RecipeIdDTO) then) = _$RecipeIdDTOCopyWithImpl<$Res>;
...
/// @nodoc
abstract class _$$_RecipeIdDTOCopyWith<$Res> implements $RecipeIdDTOCopyWith<$Res> {
  factory _$$_RecipeIdDTOCopyWith(_$_RecipeIdDTO value, $Res Function(_$_RecipeIdDTO) then) =
...
class __$$_RecipeIdDTOCopyWithImpl<$Res> extends _$RecipeIdDTOCopyWithImpl<$Res>
  ...
  __$$_RecipeIdDTOCopyWithImpl(_$_RecipeIdDTO _value, $Res Function(_$_RecipeIdDTO) _then)
...
class _$_RecipeIdDTO extends _RecipeIdDTO {
  _$_RecipeIdDTO({@JsonKey(name: "recipe_id") required this.recipe}) : super._();

  factory _$_RecipeIdDTO.fromJson(Map<String, dynamic> json) => _$$_RecipeIdDTOFromJson(json);
...
abstract class _RecipeIdDTO extends RecipeIdDTO {
  factory _RecipeIdDTO({@JsonKey(name: "recipe_id") required final RecipeDataDTO recipe}) = _$_RecipeIdDTO;
  _RecipeIdDTO._() : super._();

  factory _RecipeIdDTO.fromJson(Map<String, dynamic> json) = _$_RecipeIdDTO.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$$_RecipeIdDTOCopyWith<_$_RecipeIdDTO> get copyWith => throw _privateConstructorUsedError;
}
