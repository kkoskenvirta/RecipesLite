...
abstract class $CategoryDTOCopyWith<$Res> {
  factory $CategoryDTOCopyWith(CategoryDTO value, $Res Function(CategoryDTO) then) = _$CategoryDTOCopyWithImpl<$Res>;
...
class _$_CategoryDTO implements _CategoryDTO {
  const _$_CategoryDTO({required final List<CategoryDataDTO> data}) : _data = data;
...
abstract class _CategoryDTO implements CategoryDTO {
  const factory _CategoryDTO({required final List<CategoryDataDTO> data}) = _$_CategoryDTO;
